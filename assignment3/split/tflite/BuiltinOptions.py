...
def BuiltinOptionsCreator(unionType, table):
    ...
    if unionType == BuiltinOptions().BitwiseXorOptions:
        ...
        return tflite.BitwiseXorOptions.BitwiseXorOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().RightShiftOptions:
        import tflite.RightShiftOptions
        return tflite.RightShiftOptions.RightShiftOptionsT.InitFromBuf(table.Bytes, table.Pos)
    return None
